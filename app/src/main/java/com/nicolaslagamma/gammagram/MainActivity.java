...
public class MainActivity extends AppCompatActivity {
    ...
    public void onLaunchCamera(View view) {
        ...
        Uri fileProvider = FileProvider.getUriForFile(MainActivity.this, "com.codepath.fileprovider.gammagram", photoFile);
        ...
        if (intent.resolveActivity(getPackageManager()) != null) {
            ...
            Toast.makeText(MainActivity.this, "default camera app not found", Toast.LENGTH_SHORT).show();
        }
    }
